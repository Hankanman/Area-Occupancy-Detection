...
- **Custom Sensors**: Add any entity from any integration, binary or numeric, with no domain or device-class filter — for anything the built-in sensor types cannot express.
