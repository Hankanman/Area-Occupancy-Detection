...
class TestAllAreas:
    ...
    def test_probability_average(self, coordinator) -> None:
    ...
    def test_area_prior_average(self, coordinator) -> None:
    ...
    def test_decay_average(self, coordinator) -> None:
    ...
    def test_probability_clamps_to_bounds(self, coordinator) -> None:
    ...
    def test_probability_empty_areas(self, coordinator) -> None:
    ...
    def test_area_prior_empty_areas(self, coordinator) -> None:
    ...
    def test_decay_empty_areas(self, coordinator) -> None:
