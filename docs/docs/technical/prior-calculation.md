...
If configured, a minimum prior override is applied:
...
This ensures the prior never drops below a configured minimum, useful for areas that should always have some baseline occupancy probability.
