...
async def test_sensor_weights(hass: HomeAssistant):
    ...
    entry = MockConfigEntry(
        ...
        data={
            ...
            "sensor_weights": {
                "binary_sensor.motion": 0.8,
                "sensor.illuminance": 0.2
            },
            "threshold": 0.5,
        }
    )
...
async def test_coordinator_update_interval(hass: HomeAssistant, mock_fully_setup_entry):
    ...
    with patch("custom_components.room_occupancy.coordinator.RoomOccupancyCoordinator._async_update_data") as mock_update:
        # Force time to pass
